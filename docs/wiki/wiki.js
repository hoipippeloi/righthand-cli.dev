...
Auto-generated detailed index of every docs/wiki/ concept — the map the LLM uses to locate information. 53 concept(s). Regenerated on init and on wiki_mark_synced. Generated 2026-07-24T13:01:37.312Z.
...
## Command surface (20 commands, all auto-discovered)
...
ops domains: \`ci\`, \`logs\`, \`docs\`, \`tasks\`, \`admin\` (C8), plus \`hello\` (demo).

## Capabilities map (all 10 built, 166 tests)
